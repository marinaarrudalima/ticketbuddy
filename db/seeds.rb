...
ticket = Ticket.create!(artist: "Beatles", ticket_type: "Pista Premium", price: 120.0, city: "Sao Paulo", event_date: Date.new(2024,3,1),user: user, image_url: "app/assets/images/beatles.jpeg")
ticket = Ticket.create!(artist: "Lana Del Rey", ticket_type: "Pista", price: 110.0, city: "Curitiba-PR", event_date: Date.new(2024,3,13),user: user, image_url: "app/assets/images/lanadelrey.jpeg")
